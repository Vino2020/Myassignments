...
public class CreateDuplicateLead {
	public static void main(String[] args) 
	{
		...
		WebElement duplicateLead = driver.findElement(By.className("subMenuButton"));
		duplicateLead.click();
		
	     WebElement clearCompany = driver.findElement(By.id("createLeadForm_companyName"));
		clearCompany.clear();
		clearCompany.sendKeys("Vega Adhya");
		
		WebElement clearFirstname = driver.findElement(By.id("createLeadForm_firstName"));
		clearFirstname.clear();
		clearFirstname.sendKeys("Vikas");
		
	
		WebElement secLead = driver.findElement(By.className("smallSubmit"));
		secLead.click(); 
